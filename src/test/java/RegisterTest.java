...
public class RegisterTest {
	...
	public void checkEmailAlreadyExists() {
		...
		phoneNumber.sendKeys("99999999");
		webDriver.findElement(By.id("submit")).submit();
		Assert.assertEquals(webDriver.findElement(By.id("alert")).getText(), "The email test@test.com is already in use!");
	}
	...
	public void checkDisplayNameAlreadyExists() {
		...
		phoneNumber.sendKeys("99999999");
		webDriver.findElement(By.id("submit")).submit();
		Assert.assertEquals(webDriver.findElement(By.id("alert")).getText(), "The display name testName123 is already in use!");
	}
